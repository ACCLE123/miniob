...
static const yytype_int16 yyrline[] =
{
     ...
     634,   649,   650,   651,   652,   653,   654,   658,   671,   679,
     689,   690
};
#endif
...
#line 389 "yacc_sql.y"
      ...
      (yyval.value) = new Value(tmp, strlen(tmp), AttrType::DATES);
      free(tmp);
      free((yyvsp[0].dates));
    }
...
#line 395 "yacc_sql.y"
      ...
      (yyval.value) = new Value(tmp, strlen(tmp), AttrType::CHARS);
      free(tmp);
      free((yyvsp[0].string));
    }
